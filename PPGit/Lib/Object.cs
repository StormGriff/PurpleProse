...
namespace PPGit.Lib
{
	public abstract class Object : INotifyPropertyChanged //This will be a parent class to all objects
	{
		...
		{ 	get
			...
			set { File.WriteAllLines(description, new string[] { value }); } //Writes the history to the file
		}
		...
		{	get
			...
			set { File.WriteAllLines(history, new string[] { value }); } //Writes the history to the file
		}
